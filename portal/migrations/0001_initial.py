# Generated by Django 6.0.5 on 2026-06-04 14:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'New'), ('in_progress', 'In progres'), ('done', 'Done'), ('none', None)], default='new', max_length=20)),
                ('date_added', models.DateTimeField(auto_now_add=True, verbose_name='Date')),
                ('user_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='repair_request', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
